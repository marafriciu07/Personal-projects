...
Each product has a unique ID, name, manufacturer, and price. The program reads products from a text file, stores them in a hash table, displays the inventory, deletes products, and finds two products whose prices match a given gift card value.
...
- Assigns unique product IDs starting from `101`
